...
public class Shop extends Produtos {
    ...
    public Shop(String nome, double valor_compra, double valor_venda, int quantidade, String loja,
                String local_fabricacao, Date data_compra, String marca, int qtd_venda, String cor,
                Date data_fabricacao, String finalidade) {
